...
![image.png](./media/1583651797304-c9a60d87-0e59-4fe1-b60a-1397f5500823.png)
...
Ribbon项目不提供服务。
## 2.1 创建Maven Module
![image.png](./media/1583651919174-8b995c56-41da-47be-8929-a798bb5f4d0d.png)
...
1. 访问注册中心（[http://localhost:8761/](http://localhost:8761/)），查看服务注册情况。
  1. ![image.png](./media/1583653653811-6affd61f-7545-4f4d-9bba-38260c04faca.png)
3. 启动负载均衡ribbon。
3. 访问注册中心（[http://localhost:8761/](http://localhost:8761/)），查看服务注册情况。
  1. ![image.png](./media/1583653850172-a7f3003e-a0d7-43d2-afa3-c7fc0e4072ba.png)
5. 访问ribbon接口（[http://localhost:8040/ribbon/findAll](http://localhost:8040/ribbon/findAll)）
  1. ![image.png](./media/1583653931537-ed8ad58b-8da1-4ff7-bb33-1b0205003ca2.png)
  1. 其实此时已经时间负载均衡，只是看不到效果。
6. 访问ribbon中index服务（[http://localhost:8040/ribbon/index](http://localhost:8040/ribbon/index)）查看负载均衡效果
  1. ![image.png](./media/1583654009663-35e551ce-f6b0-401d-bec6-2475555227c6.png)
  1. ![image.png](./media/1583654030440-8888a8e1-1bb2-4c23-b32f-b189a7856335.png)
